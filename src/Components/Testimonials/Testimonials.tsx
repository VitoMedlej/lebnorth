...
const tests =[
  {
      reviewer: "John Doe",
      description: "I absolutely love the LEB NORTH Diamond Painting kits. The quality of the diamonds and the canvas is top-notch. Highly recommended!"
  },
  {
      reviewer: "Jane Smith",
      description: "The LEB NORTH Diamond Painting kit was a joy to work with. The instructions were clear and the end result was beautiful. I'm definitely buying more."
  },
  {
      reviewer: "Alex Johnson",
      description: "LEB NORTH Diamond Painting offers a great way to relax and create art at the same time. The variety of designs available is impressive."
  },
  {
      reviewer: "Emily Davis",
      description: "I'm new to diamond painting and found the LEB NORTH Diamond Painting kit to be a great starting point. The guide was easy to follow and the process was so much fun."
  }
];
