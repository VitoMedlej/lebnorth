...
`At LEB NORTH Diamond Painting, we believe that everyone is an artist. Our kits are designed to be user-friendly and suitable for crafters of all skill levels, from beginners to seasoned pros. So why wait? Dive into the world of diamond painting and discover the artist within you!`,
  ...
  return (
    <Container maxWidth='lg' className='auto' sx={{mx:1,py:4}}>
        ...
        <Typography sx={{fontSize:{xs:'2em',sm:'3em'},fontWeight:900}} component='h1'>
            About us - LEB NORTH Diamond Painting
        </Typography>
        <Box sx={{my:4}}>
                {
                    text.map(i=>{
